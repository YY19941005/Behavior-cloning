...
from keras.layers import Activation, Dense, Dropout, ELU, Flatten, LSTM, Lambda,Reshape, Conv2D, MaxPooling2D
...
def get_model():
    ...
    model = Sequential([
        ...
        Flatten(),
        Reshape((48, 1)),
        LSTM(20, activation='tanh', inner_activation='tanh', return_sequences=True),
        LSTM(10, activation='tanh', inner_activation='tanh', return_sequences=False),
