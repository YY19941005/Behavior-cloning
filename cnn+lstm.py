...
from keras.layers import Activation, Dense, Dropout, ELU, Flatten, LSTM, Lambda,Reshape,Bidirectional
...
def get_model():
    ...
    model = Sequential([
        ...
        Dropout(.3),
        Reshape((1152, 1)),
        LSTM(100, activation='tanh', inner_activation='tanh', return_sequences=True),
